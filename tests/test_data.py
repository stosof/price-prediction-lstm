...
class DataExistsInInputDirsTest(unittest.TestCase):
    ...
    def test_subdirs_exist_in_data_dir(self):
        ...
        for dir in currency_dir_paths:
            self.assertTrue(os.path.isdir(dir),
                            "The input data directory - {} - defined in config.py does not exist.".format(dir))
    ...
    def test_data_subdirs_contain_xlsx_files(self):
        ...
        for dir in currency_dir_paths:
            ...
            self.assertTrue(self._check_contains_xlsx(files_in_dir),
                            "The directory - {} - does not contain any .xlsx files".format(dir))
            self.assertFalse(self._check_contains_other(files_in_dir),
                             "The directory - {} - contains files that are not .xlsx files".format(dir))
